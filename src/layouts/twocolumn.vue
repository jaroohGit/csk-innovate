          ...
          <BContainer fluid>
            <div id="two-column-menu">
              <simplebar class="twocolumn-iconview list-unstyled">
                ...
                <li>
                  <BLink href="#sidebarApps" class="nav-icon" role="button"
                    @click.prevent="updateMenu('sidebarApps', $event)">
                    <i class="ri-apps-2-line"></i>
                  </BLink>
                </li>
                <li>
                  <BLink href="#sidebarAuth" class="nav-icon" role="button"
                    @click.prevent="updateMenu('sidebarAuth', $event)">
                    <i class="ri-account-circle-line"></i>
                  </BLink>
                </li>
                <li>
                  <BLink href="#sidebarPages" class="nav-icon" role="button"
                    @click.prevent="updateMenu('sidebarPages', $event)">
                    <i class="ri-pages-line"></i>
                  </BLink>
                </li>
                <li>
                  <BLink href="#sidebarlanding" class="nav-icon" role="button"
                    @click.prevent="updateMenu('sidebarlanding', $event)">
                    <i class="ri-rocket-line"></i>
                  </BLink>
                </li>
                <li>
                  <BLink href="#sidebarUI" class="nav-icon" role="button"
                    @click.prevent="updateMenu('sidebarUI', $event)">
                    <i class="ri-pencil-ruler-2-line"></i>
                  </BLink>
                </li>
                <li>
                  <BLink href="#sidebarAdvanceUI" class="nav-icon" role="button"
                ...
                <li>
                  <BLink href="#sidebarForms" class="nav-icon" role="button"
                    @click.prevent="updateMenu('sidebarForms', $event)">
                    <i class="ri-file-list-3-line"></i>
                  </BLink>
                </li>
                <li>
                  <BLink href="#sidebarTables" class="nav-icon" role="button"
                ...
                <li>
                  <BLink href="#sidebarCharts" class="nav-icon" role="button"
                ...
                <li>
                  <BLink href="#sidebarIcons" class="nav-icon" role="button"
                ...
                <li>
                  <BLink href="#sidebarMaps" class="nav-icon" role="button"
                ...
                <li>
                  <BLink href="#sidebarMultilevel" class="nav-icon" role="button"
              ...
              <simplebar class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                  ...
                  <div class="collapse menu-dropdown" id="sidebarApps">
                    ...
                    <ul class="nav nav-sm flex-column">
                      <li class="nav-item">
                        <BLink class="nav-link" href="#sidebarCalendar" data-bs-toggle="collapse" role="button"
                      ...
                      <li class="nav-item">
                        ...
                        <BLink class="nav-link" href="#jobs" data-bs-toggle="collapse" role="button"
                        ...
                        <div class="collapse menu-dropdown" id="jobs">
                          ...
                          <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                              ...
                              <BLink class="nav-link" href="#sidebarjoblist" data-bs-toggle="collapse" role="button"
                            ...
                            <li class="nav-item">
                              ...
                              <BLink class="nav-link" href="#sidebarcandidatelists" data-bs-toggle="collapse"
                          ...
                          <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                              <router-link to="/charts/apex-slope" class="nav-link" data-key="t-slope">{{
                                $t("t-slope") }} <span class="badge badge-pill bg-success">{{ $t('t-new')
                                  }}</span></router-link>
                            </li>
                          </ul>
                        </div>
