...
export default {
    ...
    methods: {
        ...
        handleMouseOut(event) {
            ...
            event.target.style.background = '#0ab39c';
        }
    },
    mounted() {
                                                        ...
                                                        <tbody>
                                                            <tr
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    valign="top">
                                                                    I'm writing to let you know that I can't attend
                                                                    class for two
                                                                    weeks as I've had an accident and hurt my back. I'm
                                                                    afraid I
                                                                    also need to ask for an extension for next week's
                                                                    essay.
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                        <tbody>
                                                            <tr
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    lectures so I can
                                                                    listen to them at home. I will try to catch up with
                                                                    all the
                                                                    reading too. However, I don't think I can submit the
                                                                    essay next
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    <div style="display: flex; align-items: center;">
                                                                        ...
                                                                        <div style="margin-left: 8px;">
                                                                            <span style="font-weight: 600;">Luis
                                                                                Rocha</span>
                                                                            <p
                                                        ...
                                                        <tbody>
                                                            <tr
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    valign="top">
                                                                    Since yesterday, I've been receiving thousands of
                                                                    emails, asking
                                                        ...
                                                        <tbody>
                                                            <tr
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    it. You
                                                                    won't be subscribed if you don't click the
                                                                    confirmation link
                                                                    above.
                                                                </td>
                                                            </tr>
                            ...
                            <td class="container" width="600"
                                ...
                                <div class="content"
                                                        ...
                                                        <tbody>
                                                            <tr
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    valign="top">
                                                                    Yes, we know
                                                                    <p style="margin-bottom: 13px;">An email to verify
                                                                        an email.</p>
                                                                    <p style="margin-bottom: 0;">Please validate your
                                                                        email address
                                    ...
                                    <div
                                        ...
                                        <h4
                                            style="font-weight: 500; line-height: 1.5;font-family: 'Roboto', sans-serif;">
                                            Need Help ?</h4>
                                                            ...
                                                            <tr
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    <div style="text-align: center;">
                                                                        <lock-icon class="icon-sm"
                                                                            style="color: #0ab39c;fill: rgba(10,179,156,.16); height: 30px; width: 30px;"></lock-icon>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                            ...
                                                            <tr
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    <p style="margin-bottom: 13px; line-height: 1.5;">
                                                                        ...
                                                                        can
                                                                        change
                                                                        your password for security reasons or reset it
                                                                        if
                                                                        you
                                                                        forget
                                                                        it. Your Google Account password is used to
                                                                        access
                                                                        many
                                                            ...
                                                            <tr
                                                                ...
                                                                <td class="content-block"
                                                                    ...
                                                                    <ul
                                                                        ...
                                                                        <li>
                                                                            Open your account. You might need to sign
                                                                            in.
                                                                        </li>
                                                                        <li>
                                                                        ...
                                                                        <li>
                                                                            Choose Password. You might need to sign in
                                                                            again.
                                                                        </li>
                                                                        <li>
                                                                            Enter your new password, then select Change
                                                                            Password.
                                                                        </li>
                                                                    </ul>
                                                                </td>
