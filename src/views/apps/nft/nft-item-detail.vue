...
export default {
    ...
    mounted() {
        ...
        var setEndDate1 = "March 19, 2026 6:0:0";
        var cdd1 = this.startCountDownDate(setEndDate1);

        const auctionTimeElement = document.querySelector("#auction-time-1");

        if (!auctionTimeElement) {
            console.warn("Element with id 'auction-time-1' not found.");
            return;
        }
        ...
        setInterval(() => {
            ...
            auctionTimeElement.textContent = days + " : " + hours + " : " + minutes + " : " + seconds;

            // If the count down is over, write some text
            if (distance < 0) {
                // clearInterval();
                auctionTimeElement.textContent = "00 : 00 : 00 : 00";
            }
        }, 1000);
    },
};
