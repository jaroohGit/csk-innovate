                ...
                <simplebar data-simplebar style="max-height: 364px;" class="p-3">
                  <div class="acitivity-timeline acitivity-main">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1">Today offers by <router-link to="/ecommerce/seller-details" class="link-secondary">
                ...
                <div>
                  ...
                  <div class="d-flex flex-wrap gap-2 select-color">
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="Out of Stock">
                      <BButton variant="link" class="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-22 text-primary" disabled>
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </BButton>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="03 Items Available">
                      <BButton variant="link" class="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-22 text-secondary">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </BButton>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="03 Items Available">
                      <BButton variant="link" class="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-22 text-success">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </BButton>
                    </div>
                    <div data-bs-toggle="tooltip" v-b-tooltip.hover title="02 Items Available">
                      <BButton variant="link" class="avatar-xs p-0 d-flex align-items-center justify-content-center border rounded-circle fs-22 text-info">
                        <i class="ri-checkbox-blank-circle-fill"></i>
                      </BButton>
                    </div>
                  </div>
