...
export default [
  ...
  },
  {
    ...
    name: "dashboard-blog",
    meta: {
      title: "Blog Dashboard", authRequired: true,
    },
  ...
  },
  {
    ...
    component: () => import("../views/pages/blogs/list-view"),
  },
  {
    path: "/blogs/grid-view",
    name: "grid-view",
    meta: { title: "Blogs", authRequired: true },
    component: () => import("../views/pages/blogs/grid-view"),
  },
  {
    path: "/blogs/overview",
    name: "overview",
    meta: { title: "Blogs", authRequired: true },
    component: () => import("../views/pages/blogs/overview"),
  },
  {
    path: "/charts/chartjs",
    name: "chartjs-chart",
  ...
  },
  {
    ...
    component: () => import('../views/charts/apex/slope/index')
  },
  {
