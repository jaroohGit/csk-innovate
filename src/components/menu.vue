  ...
  <BContainer fluid>
    ...
    <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
      <ul class="navbar-nav h-100" id="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse menu-dropdown" id="sidebarApps">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item">
                <BLink class="nav-link" href="#sidebaremail" data-bs-toggle="collapse" role="button" aria-expanded="false"
              ...
              <li class="nav-item">
                <BLink class="nav-link" href="#jobs" data-bs-toggle="collapse" role="button" aria-expanded="false"
        ...
        <li class="nav-item">
          ...
          <div class="collapse menu-dropdown" id="sidebarAuth">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item">
                <BLink class="nav-link" href="#sidebarcreatepassword" data-bs-toggle="collapse" role="button"
        ...
        <li class="nav-item">
          <BLink class="nav-link" href="#sidebarlanding" data-bs-toggle="collapse" role="button" aria-expanded="false"
